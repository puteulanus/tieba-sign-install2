...
$("#zw_custompage_all_able").click(function(){
	createWindow().setTitle("全部启用").setContent('你确定要启用全部页面吗？').addButton("确定", function(){msg_callback_action('plugins/zw_custompage/ajax.php?action=allable',zw_custompage_load_set);}).addCloseButton("取消").append();
});	

$("#zw_custompage_all_unable").click(function(){
	createWindow().setTitle("全部关闭").setContent('你确定要关闭全部页面吗？').addButton("确定", function(){msg_callback_action('plugins/zw_custompage/ajax.php?action=allunable',zw_custompage_load_set);}).addCloseButton("取消").append();
});	

$("#zw_custompage_turnedtoother").click(function(){
	createWindow().setTitle("全部关闭").setContent('你确定要反向开关吗？').addButton("确定", function(){msg_callback_action('plugins/zw_custompage/ajax.php?action=turnedtoother',zw_custompage_load_set);}).addCloseButton("取消").append();
});	

function zw_custompage_load_set(){
	showloading();
	$.getJSON("plugins/zw_custompage/ajax.php?action=getsetting", function(result){
...
function del_custompage(id){
	createWindow().setTitle('删除页面').setContent('确认要删除这个页面吗？').addButton('确定', function(){ msg_callback_action("plugins/zw_custompage/ajax.php?action=delpage&id="+id,zw_custompage_load_set); }).addCloseButton('取消').append();
	return false;
}
